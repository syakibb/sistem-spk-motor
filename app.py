# Nama file: app.py (Versi 4.9 - Final & Stabil untuk Deployment)
...
# knowledge_map tidak perlu diubah, versi Anda sudah lengkap
knowledge_map = {
    ...
    'gejala_utama': {
        ...
        'pilihan': {
            ...
            'masalah_penggerak': 'Masalah pada area penggerak roda.',
    ...
    'sudah_jumper_aki': { 'pertanyaan': "Untuk memastikan, apakah Anda sudah mencoba melakukan jumper dari aki motor lain yang sehat?", 'pilihan': {'sudah_dan_sama': "Sudah, tapi hasilnya tetap sama.", 'belum_coba': "Belum, saya belum mencoba jumper."}},
    ...
    'kondisi_mil': { 'pertanyaan': 'Apakah lampu indikator mesin/MIL menyala atau berkedip (untuk Injeksi)?', 'pilihan': {'mil_menyala': 'Ya, menyala/berkedip', 'mil_tidak_menyala': 'Tidak, lampu MIL normal'} },
    ...
    'jenis_suara_kasar': { 'pertanyaan': 'Seperti apa suara kasar yang terdengar?', 'pilihan': {'kletek_di_head': "Bunyi 'kletek-kletek' di bagian atas mesin.", 'kemrosok_di_mesin_tengah': "Bunyi 'kemrosok' dari bagian tengah/bawah mesin."}},
...
def diagnose():
    # Inisialisasi atau reset sesi jika diminta
    ...
    def render_pertanyaan(key):
        ...
        if 'pilihan_sebelumnya' in session:
            jawaban_sebelumnya_pop = session.pop('pilihan_sebelumnya')
            data_pertanyaan['jawaban_sebelumnya'] = jawaban_sebelumnya_pop
        else:
            data_pertanyaan['jawaban_sebelumnya'] = None
